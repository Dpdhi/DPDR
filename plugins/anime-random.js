...
https://api-reysekha.herokuapp.com/api/nsfw/ass?apikey=APIKEY
conn.sendButtonImg(m.chat, haha.data, `nih ngab ${command}`, titlebot, '🔄 NEXT 🔄', `.${command}`, m)}
if (command == 'ayuzawa') {
...
conn.sendButtonImg(m.chat, haha.data, `nih ngab ${command}`, titlebot, '🔄 NEXT 🔄', `.${command}`, m)}
if (command == 'cosplay') {
let haha = await conn.getFile(`https://api-reysekha.herokuapp.com/api/random/cosplay?apikey=APIKEY`)
conn.sendButtonImg(m.chat, haha.data, `nih ngab ${command}`, titlebot, '🔄 NEXT 🔄', `.${command}`, m)}
}
